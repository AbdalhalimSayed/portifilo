        ...
        <div class="container-fluid p-4">
            ...
            <div class="d-flex flex-wrap align-items-start justify-content-between gap-3 mb-5">
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    <div>
                        <h1 class="fw-bold display-6 mb-1 text-dark">Add New Project</h1>
                        <p class="text-muted">add and manage your project information, media, and links.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-8 d-flex flex-column gap-4">
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            ...
                            <textarea class="form-control bg-light" id="projectDesc"
                                      wire:model.live.debounce.500ms='short_description' rows="3"
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            ...
                            <textarea class="form-control bg-light" wire:model.live.debounce='description'
                                      id="projectDesc"
                                      rows="6"
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                <!-- Image 1 -->
                                @if ($image && !is_string($image) && method_exists($image, 'temporaryUrl') && $image->isPreviewable())
                                ...
                                @elseif($image && !is_string($image))
                                    <p class="text-muted mt-2">File Selected: {{ $image->getClientOriginalName() }}
                                    </p>
                                @endif
